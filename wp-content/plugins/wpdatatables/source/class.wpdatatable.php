...
class WPDataTable {
    ...
    protected function enqueueJSAndStyles() {
        ...
        wp_enqueue_script('wdt-common', WDT_ROOT_URL . 'assets/js/wpdatatables/adm/common.js', array(), WDT_CURRENT_VERSION, true);
        if (get_option('wdtMinifiedJs')) {
            ...
            wp_localize_script('wdt-wpdatatables', 'wdt_ajax_object', array( 'ajaxurl' => WDT_ROOT_URL.'controllers/wdt_ajax.php' ));
        } else {
    ...
    public function getJsonDescription() {
        ...
        //[<-- Full version -->]//
        if ($this->isEditable()) {
            $obj->fileUploadBaseUrl = WDT_ROOT_URL.'controllers/wdt_ajax.php?action=wdt_upload_file&table_id=' . $this->getWpId();
            $obj->adminAjaxBaseUrl = WDT_ROOT_URL.'controllers/wdt_ajax.php';
