...
function wdtAdminEnqueue($hook)
{
    ...
    wp_register_style('wdt-browse-css', WDT_CSS_PATH . 'adm/browse.css', array(), WDT_CURRENT_VERSION);
    ...
    wp_register_script('wdt-color-pickr-init', WDT_ROOT_URL . 'assets/js/wpdatatables/adm/wdt.color-picker-init.js', array(), WDT_CURRENT_VERSION, true);
    wp_register_script('wdt-common', WDT_ROOT_URL . 'assets/js/wpdatatables/adm/common.js', array(), WDT_CURRENT_VERSION, true);
    wp_register_script('wdt-funcs-js', WDT_JS_PATH . 'wpdatatables/wdt.funcs.js', array('jquery', 'wdt-common'), WDT_CURRENT_VERSION, true);
    wp_register_script('wdt-doc-js', WDT_JS_PATH . 'wpdatatables/adm/doc.js', array('jquery', 'wdt-common'), WDT_CURRENT_VERSION, true);

    wp_enqueue_style('wdt-admin', WDT_CSS_PATH . 'adm/adm.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_style('wdt-color-pickr-classic', WDT_CSS_PATH . 'color-pickr/classic-theme.min.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-rating', WDT_JS_PATH . 'wpdatatables/adm/wdtRating.js', array('jquery'), WDT_CURRENT_VERSION, true);
...
function wdtBrowseTablesEnqueue()
{
    ...
    wp_enqueue_script('wdt-browse-js', WDT_JS_PATH . 'wpdatatables/adm/browse/wdt.browse.js', array(), WDT_CURRENT_VERSION, true);
...
function wdtEditEnqueue()
{
    ...
    wp_enqueue_style('wdt-edit-table-css', WDT_CSS_PATH . 'adm/edit_table.css', array(), WDT_CURRENT_VERSION);
    ...
    wp_enqueue_script('wdt-column-config', WDT_JS_PATH . 'wpdatatables/adm/table-settings/column_config_object.js', array(), WDT_CURRENT_VERSION, true);
    wp_enqueue_script('wdt-table-config', WDT_JS_PATH . 'wpdatatables/adm/table-settings/table_config_object.js', array(), WDT_CURRENT_VERSION, true);
    wp_enqueue_script('wdt-edit-main-js', WDT_JS_PATH . 'wpdatatables/adm/table-settings/main.js', array(), WDT_CURRENT_VERSION, true);
    if (isset($_GET['table_id']) && isset($_GET['simple'])) {
        wp_enqueue_style('wdt-star-rating-css', WDT_CSS_PATH . 'adm/starRating.min.css', array(), WDT_CURRENT_VERSION);
        ...
        wp_enqueue_script('wdt-star-rating-js', WDT_JS_PATH . 'wpdatatables/adm/starRating.min.js', array('jquery'), WDT_CURRENT_VERSION, true);
        wp_enqueue_script('wdt-simple-table-js', WDT_JS_PATH . 'wpdatatables/adm/constructor/wdt.simpleTable.js', array('jquery'), WDT_CURRENT_VERSION, true);
    ...
    wp_enqueue_script('wdt-doc-js');
    wp_localize_script('wdt-advanced-filter', 'wdt_ajax_object', array('ajaxurl' => WDT_ROOT_URL.'controllers/wdt_ajax.php'));
...
function wdtConstructorEnqueue()
{
    ...
    wp_enqueue_style('wdt-wpdatatables');
    wp_enqueue_style('wdt-constructor-css', WDT_CSS_PATH . 'adm/constructor.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_style('wdt-dragula');
    ...
    wp_enqueue_script('wdt-color-pickr-init');
    wp_enqueue_script('wdt-funcs-js');
    wp_enqueue_script('wdt-constructor-main-js', WDT_JS_PATH . 'wpdatatables/adm/constructor/wdt.constructor.js', array(), WDT_CURRENT_VERSION, true);
    wp_enqueue_script('wdt-doc-js');
...
function wdtChartWizardEnqueue()
{
    ...
    wp_enqueue_style('wdt-dragula');
    wp_enqueue_style('wdt-chart-wizard-css', WDT_CSS_PATH . 'adm/chart_wizard.css', array(), WDT_CURRENT_VERSION);
...
function wdtSettingsEnqueue()
{
    ...
    wp_enqueue_style('wdt-settings-css', WDT_CSS_PATH . 'adm/settings.css', array(), WDT_CURRENT_VERSION);

    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-color-pickr-init');
    wp_enqueue_script('wdt-plugin-config', WDT_ROOT_URL . 'assets/js/wpdatatables/adm/plugin-settings/plugin_config_object.js', array(), WDT_CURRENT_VERSION, true);
    wp_enqueue_script('wdt-settings-main-js', WDT_ROOT_URL . 'assets/js/wpdatatables/adm/plugin-settings/main.js', array(), WDT_CURRENT_VERSION, true);
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-dashboard-css', WDT_CSS_PATH . 'adm/dashboard.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-support-css', WDT_CSS_PATH . 'adm/support.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
}
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-welcome-page-css', WDT_CSS_PATH . 'adm/welcome-page.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-getting-started-css', WDT_CSS_PATH . 'adm/getting-started.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
}
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-system-info-css', WDT_CSS_PATH . 'adm/system-info.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
...
{
    WDTTools::wdtUIKitEnqueue();
    wp_enqueue_style('wdt-lite-vs-premium-css', WDT_CSS_PATH . 'adm/lite-vs-premium.css', array(), WDT_CURRENT_VERSION);
    wp_enqueue_script('wdt-common');
    wp_enqueue_script('wdt-doc-js');
}
...
function wdtAddOnsEnqueue()
{
    ...
    wp_enqueue_style('wdt-add-ons-css', WDT_CSS_PATH . 'adm/addons.css', array(), WDT_CURRENT_VERSION);
