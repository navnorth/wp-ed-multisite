...
echo "<div class=\"wrap usacustom-html5-map full\"><h2>" . __('Configuration of Map points', 'usacustom-html5-map') . "</h2>";
?>
<style>
.tipsy-w {
    z-index: 50500;
...
$mapCfg = array(
        ...
        'pointNameFontFamily'   => usacustom_html5map_plugin_escape_fonts($options[$map_id]['pointNameFontFamily'] ? $options[$map_id]['pointNameFontFamily'] : $options[$map_id]['nameFontFamily'], 'Arial, sans-serif'),
